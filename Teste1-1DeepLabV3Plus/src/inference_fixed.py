...
# FIXED PATHS - Adjust these to your setup
input_dir = '../dataset_35/images'  # Path to your .tif images
model_path = 'output_35/K1x5noAug_unetb45drop2_imgnet_ADAM0WD_TVERSKY1.0-0.5_noWeight/best_epoch.pth.tar'  # Path to trained model
output_dir = 'inference_results'  # Output directory
selected_files_path = 'folds/fold5_images.txt'  # Which images to process
